...
public class StartUITest {
    ...
    public void whenUserAddItemThenTrackerHasAllItems() {
        ...
        assertThat(
                ...
                is(
                        new StringBuilder()
                                .append("Меню." + System.lineSeparator() + "0. Добавить новый элемент" + System.lineSeparator())
                                .append("1. Показать все элементы" + System.lineSeparator() + "2. Редактировать элемент" + System.lineSeparator() + "3. Удалить элемент" + System.lineSeparator())
                                .append("4. Найти элемент по ID" + System.lineSeparator() + "5. Найти элементы по названию" + System.lineSeparator())
                                .append("------------ Отображение всех заявок --------------" + System.lineSeparator())
        ...
        assertThat(
                ...
                is(
                        new StringBuilder()
                                ...
                                .append("1. Показать все элементы" + System.lineSeparator() + "2. Редактировать элемент" + System.lineSeparator() + "3. Удалить элемент" + System.lineSeparator())
                                .append("4. Найти элемент по ID" + System.lineSeparator() + "5. Найти элементы по названию" + System.lineSeparator())
                                .append("------------ Поиск заявок по названию --------------" + System.lineSeparator())
                                .append("Номер ID заявки: " + itemOne.getId() + "\n")
                                .append("Название заявки: one name\n")
                                .append("Описание заявки: null\n\n" + System.lineSeparator())
                                .append("Номер ID заявки: " + itemFour.getId() + "\n")
